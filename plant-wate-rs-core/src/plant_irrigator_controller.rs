...
use crate::plant_irrigator::{Percentage, PlantIrrigator, SensorCalibrationResult, TargetMoistureLevel};
use crate::uc::{AnalogValue, GPIO_0, GPIO_2, Microcontroller};
...
impl<MicrocontrollerImpl: Microcontroller> PlantIrrigatorController<MicrocontrollerImpl> {
    pub fn new(microcontroller: &mut MicrocontrollerImpl) -> Self {
        ...
        let calibration_result = SensorCalibrationResult::new(AnalogValue::new(1027), AnalogValue::new(2526));
        let target_moisture_level = TargetMoistureLevel::new(Percentage::new(40), Percentage::new(70));

        Self {
            plant_irrigator_1: PlantIrrigator::new(sensor_1, pump_1, calibration_result, target_moisture_level),
        }
    }
